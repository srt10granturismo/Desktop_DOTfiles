...
--	awful.util.spawn_with_shell("xrandr --dpi 110")
    end
end
...
globalkeys = table_join(
    ...
    awful.key({ modkey,           }, "t", function () awful.util.mymainmenu:show() end,
...
--[[
    ...
    awful.key({ altkey }, "v", function ()
        ...
        {description = "toggle vertical wibox", group = "awesome"}),
--]]
    ...
    awful.key({ modkey, "Shift" }, "c", function () lain.util.rename_tag() end,
    ...
    --Layout manipulation
    awful.key({ modkey, "Shift"   }, "u",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "p",     function () awful.tag.incmwfact(-0.05)          end,
              {description = "decrease master width factor", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "i",     function () awful.client.incwfact( 0.05)          end,
              {description = "increase master hieght factor", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "o",     function () awful.client.incwfact(-0.05)          end,
              {description = "decrease master hieght factor", group = "layout"}),
    ...
    awful.key({ }, "XF86AudioMute",
       function ()
	   os.execute(string.format("pamixer -t", beautiful.volume.channel))
	   beautiful.volume.update()
       end),
    awful.key({ altkey }, "Up",
        function ()
    ...
    awful.key({ altkey, "Control" }, "m",
        function ()
            os.execute(string.format("pamixer --set-volume 100", beautiful.volume.channel))
            beautiful.volume.update()
        end),
...
--]]
    ...
    awful.key({ modkey, "Shift"  }, "w", function () awful.spawn(browser2) end,
	      {description = "run alternate browser", group = "launcher"}),
    awful.key({ modkey, "Shift"  }, "f", function () awful.spawn(firefox) end,
              {description = "run fn browser", group = "launcher"}),
    awful.key({ modkey }, "a", function () awful.spawn(guieditor) end,
              {description = "run gui editor", group = "launcher"}),
    awful.key({ modkey }, "v", function () awful.spawn(terminal.." -e vis") end,
              {description = "run a visualizer", group = "launcher"}),
    ...
    awful.key({ modkey,  "Control"}, "i", function () awful.spawn(terminal.." -e  vtop") end,
	      {description = "open a cooler htop", group = "launcher"}),
    awful.key({ modkey,		  }, "a", function () awful.spawn(arandr) end,
	      {description = "open arandr", group = "launcher"}),
    awful.key({ modkey,	"Shift"   }, "a", function () awful.spawn(audio) end,
	      {description = "open pavucontrol", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "v", function () awful.spawn(vbox) end,
	      {description = "open VirtualBox", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "s", function () awful.spawn(synergy) end,
	      {description = "open synergy", group = "Launcher"}),
